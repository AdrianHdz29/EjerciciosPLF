...
calificacionesFor = [{"titulo":pelicula["Titulo"], "calificacion":pelicula["CalificaciónIMDB"]} for pelicula in peliculas]

calificacionesMap = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, peliculas))

print(calificacionesFor)
print(calificacionesMap)
# import json
# print(json.dumps(calificacionesMap, indent = 2))