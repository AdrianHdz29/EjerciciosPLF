...
gran_calificacion = list(filter(lambda calificado: float(calificado["CalificaciónIMDB"]) >= 8, peliculas))

nueva_lista = list(map(lambda pelicula: {"titulo": pelicula["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, gran_calificacion))

# print(gran_calificacion)
# print(nueva_lista)

import json
print(json.dumps(gran_calificacion, indent=2))
